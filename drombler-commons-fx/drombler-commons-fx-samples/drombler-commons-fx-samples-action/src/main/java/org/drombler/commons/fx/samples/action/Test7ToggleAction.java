...
public class Test7ToggleAction extends AbstractFXAction implements FXToggleAction {

    private final BooleanProperty selected = new SimpleBooleanProperty(this, "selected");

    public Test7ToggleAction() {
        setDisplayName("Test _7");
        setAccelerator(KeyCombination.keyCombination("Shortcut+7"));
        setGraphicFactory(new IconFactory("seven.png", new ResourceLoader(Test7ToggleAction.class), false));
        selected.addListener((ObservableValue<? extends Boolean> ov, Boolean oldValue, Boolean newValue)
                -> System.out.println("Test7ToggleAction selection changed: " + newValue));
    }
