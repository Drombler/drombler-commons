...
/**
 * A base class for {@link ActiveContextSensitive} {@link FXAction}s.
 *
 * @param <T> the type of the action command
 */
public abstract class AbstractActiveContextSensitiveFXAction<T> extends AbstractFXAction implements ActiveContextSensitive, AutoCloseable {
     ...
     */
    public AbstractActiveContextSensitiveFXAction(Class<T> type) {
        this.type = type;
    }
