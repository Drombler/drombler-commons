...
/**
 * A base class for
 * {@link ApplicationContextSensitive} {@link FXToggleAction}s.
 *
 * @param <T> the type of the action command
 */
public abstract class AbstractApplicationContextSensitiveFXToggleAction<T> extends AbstractFXToggleAction implements ApplicationContextSensitive, AutoCloseable {
     ...
     */
    public AbstractApplicationContextSensitiveFXToggleAction(Class<T> type) {
        this.type = type;
    }
